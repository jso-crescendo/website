  ...
  return (
    <ContentContainer title="Über das Orchester">
      ...
      >
        ...
        auf der ganzen Welt.
        <br />
        Im Sommer 2025 waren wir für zwei Wochen in Griechenland unterwegs und
        gaben dort sechs Konzerte. 2023 reisten wir nach Italien. Zwischen Üben
        und Konzertieren gibt es Zeit für Spiele, zum Jammen, Baden und Tanzen,
        um neue Freundschaften zu schliessen sowie alte zu besiegeln.
        Konzertreisen stellen nicht nur eine kulturelle Erfahrung auf
        internationalen Bühnen dar, sondern schenkt den jungen Leuten
        gemeinsame, unvergessliche Momente.
      </ImageSection>
      <KaethiSection />
      {/* <NoelieSection /> */}
      <ImageSection
