  ...
  return (
    <>
      ...
      <ContentContainer id="content">
        ...
        <ImageSection
          title="Unterstütze unser Crowdfunding!"
          video={{
            vertical: false,
            videoId: 'KPw2KVJsQFE',
            type: 'youtube',
          ...
          link={{
            href: 'https://wemakeit.com/projects/klassik-trifft-auf-shakepop',
            text: '👉 Jetzt unterstützen auf wemakeit.com',
          }}
        >
          Etwas Besonderes entsteht: Das JSO Crescendo und das Klaus Egger Trio
          wagen gemeinsam ein genreübergreifendes Konzerterlebnis. Arrangeur
          Janos Mijnssen hat drei Stücke der Shakepop-Band eigens für unser
          Orchester gesetzt – ein Klangabenteuer, das Sinfonik und handgemachten
          Pop auf selbstverständliche Weise verschmelzen lässt.
          <br />
          Die Uraufführung findet am 11. und 12. April 2026 statt. Damit das
          Projekt Wirklichkeit wird, brauchen wir deine Hilfe: Auf wemakeit
          läuft noch bis zum 8. April unser Crowdfunding – und es gilt «Alles
          oder Nichts».
        </ImageSection>
