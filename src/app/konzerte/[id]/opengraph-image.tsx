  ...
  if (concert?.openGraphImage) {
    ...
    try {
      ...
      return new ImageResponse(
        ...
        >
          {/* biome-ignore lint/performance/noImgElement: next/image is not available inside ImageResponse */}
          {/* biome-ignore lint/a11y/useAltText: OG image is presentational, no alt needed */}
