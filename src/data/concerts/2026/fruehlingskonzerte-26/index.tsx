...
export const FRUEHLINGSKONZERTE_26: Concert = {
  ...
  image_lg: Image_lg,
  seoDescription: `
  Musik, die unter die Haut geht. Von Webers dunkler Romantik über Elgars rätselhaftes Porträtgalerie bis hin zu einem Lied, das zehntausende Frauen auf die Strassen getrieben hat – die Frühlingskonzerte 2026 erzählen grosse Geschichten. Und das Klaus Egger Trio bringt das Leben selbst auf die Bühne. Wir freuen uns auf euch.`,
  descriptionElement: <></>,
  showOnHomepage: true,
  program: [
    {
