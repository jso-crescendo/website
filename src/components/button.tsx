...
export const Button: React.FC<
  ButtonProps &
    React.DetailedHTMLProps<
      ...
      HTMLButtonElement
    >
> = ({text, variant, className, disabled, loading, ...rest}) => (
  <button
    className={classNames(
      ...
      'focus:outline-none focus:ring-4',
      {
        ...
        'cursor-not-allowed bg-neutral-300 text-on-background':
          disabled && !loading,
        'cursor-wait bg-neutral-50 text-on-background ring-2 ring-neutral-600':
          loading,
      },
      className,
    )}
  ...
  >
    {loading && (
      <svg
        aria-hidden="true"
        role="status"
        className="mr-3 inline size-4 animate-spin text-neutral-200"
        viewBox="0 0 100 101"
        fill="none"
